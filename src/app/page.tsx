...
// https://api.openweathermap.org/data/2.5/forecast?q=pune&id=524901&appid=cad8bd47804a221df02cf531e02c72da&cnt=56
...
export default function Home() {
  ...
  const { isLoading, error, data, refetch } = useQuery<WeatherData>(
    ...
    async () => {
      const { data } = await axios.get(
        `https://api.openweathermap.org/data/2.5/forecast?q=${place}&cnt=60&appid=${process.env.NEXT_PUBLIC_WEATHER_KEY}`)
      return data;
    }
  );
  ...
  // Filtering data to get the first entry after 6 am for aech unique date
